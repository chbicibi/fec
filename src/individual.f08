module individual
    use util, only: integers, join, nformat, random_array,serstr, shuffle, string
    use interface
    implicit none
    ...
    subroutine print_d(this, unit)
        ...
        n = size(this%objectives)
        format = "(i0','" // nformat(n, "es15.8", ",") // ")"
    ...
    subroutine print_dc(this, unit)
        ...
        n = size(this%objectives) + size(this%constraints)
        format = "(i0','" // nformat(n, "es15.8','") // "l0)"
    ...
    subroutine print_ic(this, unit)
        ...
        format = "(i0','" // nformat(n, "es15.8','") // "l0)"
        write(unit, format, advance='no') this%id, this%objectives, &
                                          this%constraints, this%feasible
    ...
    subroutine print_wv_d(this, unit)
        ...
        n = size(this%objectives) + size(this%dvariables)
        format = "(i0','" // nformat(n, "es15.8", ",") // ")"
    ...
    subroutine print_wv_dc(this, unit)
        ...
        n = size(this%objectives) + size(this%dvariables) + size(this%constraints)
        format = "(i0','" // nformat(n, "es15.8','") // "l0)"
        write(unit, format, advance='no') this%id, this%objectives, &
            this%dvariables, this%constraints, this%feasible
    ...
    subroutine print_wv_dcp(this, unit, proc)
        ...
        format = "(i0','" // nformat(n, "es15.8','") // "l0)"
        write(unit, format, advance='no') this%id, this%objectives, &
            proc(this%dvariables), this%constraints, this%feasible
    ...
    subroutine print_wv_ic(this, unit)
        ...
        no = size(this%objectives)
        nv = size(this%dvariables)
        nc = size(this%constraints)
        format = "(i0','" // nformat(no, "es15.8','") &
                          // nformat(nv, "i0','")     &
                          // nformat(nc, "es15.8','") // "l0)"
        write(unit, format, advance='no') this%id, this%objectives, &
            this%ivariables, this%constraints, this%feasible
